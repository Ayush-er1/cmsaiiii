      ...
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button onClick={() => setLocation("/users/enroll")} className="gap-2 h-11 px-6 shadow-md hover:shadow-lg transition-all">
                ...
                {loading ? (
                  ...
                  <TableRow>
                    <TableCell colSpan={5} className="h-24 text-center text-muted-foreground">
                      {error ? (
                        <span className="text-destructive">Failed to load data. Is the backend running on port 8001?</span>
                      ) : (
