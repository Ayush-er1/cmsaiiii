...
import { ProfileFormData, roleLabels } from "@/types/users";
            ...
            <Card>
                <CardContent className="pt-6 flex flex-col items-center gap-4">
                    <div className="relative">
                        <Avatar className="h-32 w-32 border-4 border-background shadow-lg">
                            ...
                            <AvatarFallback className="text-4xl bg-muted">
                                {userFullName.trim() ? getInitials(userFullName) : <Camera className="h-10 w-10 text-muted-foreground/50" />}
                            </AvatarFallback>
                        </Avatar>
                        <Button
                            type="button"
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-sm text-muted-foreground">{roleLabels[data.role]}</p>
                    </div>
                </CardContent>
            </Card>
                                ...
                                >
                                    ...
                                    <button
                                        ...
                                        onClick={() => {
                                            setData({
                                                ...data,
                                                subRoles: data.subRoles?.filter(r => r !== role) || []
                                            });
                                        }}
                                    >
                                        <X className="h-3 w-3" />
