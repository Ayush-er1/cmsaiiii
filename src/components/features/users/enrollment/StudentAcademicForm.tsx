...
import { StudentFormData } from "@/types/users";
...
export function StudentAcademicForm({ data, setData }: StudentAcademicFormProps) {
    return (
                ...
                <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            onChange={(e) => setData({ ...data, guardianContact: e.target.value })}
